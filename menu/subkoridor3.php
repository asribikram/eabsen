                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <select class="form-control" id="nama" name="nama">
                                ...
                                <?php
                                    ...
                                    $query = "SELECT nama FROM karyawan WHERE kategori='Koridor 3'"; // Ganti "jabatan" dengan nama tabel Anda
                        ...
                        <div class="col">
                            ...
                            <select class="form-control" id="jabatan" name="jabatan">
                                ...
                                <?php
                                    // Ambil data jabatan dari database
                                    $query = "SELECT jabatan FROM karyawan WHERE kategori='Koridor 3'"; // Ganti "jabatan" dengan nama tabel Anda
                                    $result = mysqli_query($conn, $query);
